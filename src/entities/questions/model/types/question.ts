...
import { Skill } from '@/entities/skills/@x/questions';
// eslint-disable-next-line @conarti/feature-sliced/layers-slices
import { Specialization } from '@/entities/specializations/@x/questions';
import { type Author, type Response } from '@/shared/types';
