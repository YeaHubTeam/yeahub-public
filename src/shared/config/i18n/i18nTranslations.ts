...
export enum Vacancies {
	...
	RESUME_ANALYZER_RECOMMENDATIONS_TITLE = 'resume_analyzer_page.recommendations.title',
	RESUME_ANALYZER_RECOMMENDATIONS_DESCRIPTION = 'resume_analyzer_page.recommendations.description',
	RESUME_ANALYZER_RECOMMENDATIONS_IMAGE_ALT = 'resume_analyzer_page.recommendations.image_alt',
