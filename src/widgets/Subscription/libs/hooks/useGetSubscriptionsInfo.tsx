...
import { SubscriptionInfoBenefit, premiumBenefits } from '../../model/constants/benefitsConstants';
...
export const useGetSubscriptionsInfo = (): SubscriptionInfo[] => {
	...
	const visibleSubscriptions: SubscriptionCode[] = ['month', 'quarter', 'year'];
	...
	const subscriptions: SubscriptionInfo[] = filteredSubscriptions.map(
		({ id, code, discount, finalPrice, pricePerMonth }) => ({
			...
			trialInfo: t(Subscription.CARD_SUBTITLE_FREE),
		}),
	);
